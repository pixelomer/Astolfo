...
@class Astolfo_FLAnimatedImage;
@protocol Astolfo_FLAnimatedImageViewDebugDelegate;


//
//  An `Astolfo_FLAnimatedImageView` can take an `Astolfo_FLAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface Astolfo_FLAnimatedImageView : UIImageView
...
@property (nonatomic, strong) Astolfo_FLAnimatedImage *animatedImage;
