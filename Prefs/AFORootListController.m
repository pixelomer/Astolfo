...
- (instancetype)init {
    ...
    if (self) {
        AFOAppearanceSettings* appearanceSettings = [[AFOAppearanceSettings alloc] init];
        ...
        self.iconView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/AstolfoPrefs.bundle/icon@2x.png"];
...
- (void)viewDidLoad {
    ...
    self.headerImageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/AstolfoPrefs.bundle/Banner.png"];
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/Library/MobileSubstrate/DynamicLibraries/Astolfo.disabled"]) return;
    [[self enableSwitch] setEnabled:NO];

    UIAlertController* alertController = [UIAlertController alertControllerWithTitle:@"Astolfo"
	message:@"Astolfo Preferences disabled due to Astolfo being disabled with iCleaner Pro"
...
- (void)toggleState {
    ...
    NSString* path = [NSString stringWithFormat:@"/var/mobile/Library/Preferences/love.litten.astolfopreferences.plist"];
    NSMutableDictionary* dictionary = [NSMutableDictionary dictionaryWithContentsOfFile:path];
    NSSet* allKeys = [NSSet setWithArray:[dictionary allKeys]];
    HBPreferences* preferences = [[HBPreferences alloc] initWithIdentifier: @"love.litten.astolfopreferences"];
    
    if (!([[NSFileManager defaultManager] fileExistsAtPath:@"/var/mobile/Library/Preferences/love.litten.astolfopreferences.plist"])) {
        enabled = YES;
...
- (void)resetPrompt {
    ...
    UIAlertController* resetAlert = [UIAlertController alertControllerWithTitle:@"Astolfo"
...
- (void)resetPreferences {
    ...
    [[NSFileManager defaultManager] removeItemAtPath:@"/var/mobile/Library/Preferences/love.litten.astolfopreferences/" error:nil];
